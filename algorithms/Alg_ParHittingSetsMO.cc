...
bool ParHittingSetsMO::diagnose(Solution::OneSolution &osol,
                                vec<Lit> &assmpts) {
...
bool ParHittingSetsMO::absorb(Solution::OneSolution &osol, int bvar) {
  // {
...
bool ParHittingSetsMO::recycleLowerBoundSet() {
  ...
  //        solver->conflicts - conflicts_before, solver->conflicts,
  //        nConflicts);
  //
  //   if (sat == l_True) {
  //     nbSatisfiable++;
