...
#include <iterator>
namespace rootLits {
enum class iterators { GeQ, Strat };

template <class pointer_out = myType::iterator,
          class value_type_out = myType::iterator::value_type>
class GIterator {
public:
...
template <class pointer_out = myType::iterator,
          class value_type_out = myType::iterator::value_type>
class IteratorT : GIterator<pointer_out, value_type_out> {

public:
  using value_type =
      typename GIterator<pointer_out, value_type_out>::value_type;
  ...
  friend bool operator==(const IteratorT &a, const IteratorT &b) {
...
using CIterator =
    IteratorT<myType::const_iterator, myType::const_iterator::value_type>;
