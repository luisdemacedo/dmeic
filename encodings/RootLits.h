...
public:
  RootLitsSliced(RootLits &&_muse, PBObjFunction _pb)
      : muse{_muse}, me{}, ref{&muse}, pb{std::move(_pb)}, cur{} {}
  RootLitsSliced(RootLitsSliced &&other)
      : muse{std::move(other.muse)}, me{std::move(other.me)},
        ...
        ref{&muse}, pb{std::move(other.pb)}, cur{std::move(other.cur)} {
    other.ref = nullptr;
  }
